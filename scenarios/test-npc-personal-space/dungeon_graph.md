...
# test-npc-personal-space — Scenario Graph Reference

Test scenario for NPC personal space behavior - Phase 4
...
flowchart TD
  ...
  node_start(("▶"))
  node_start --> test_personal_space

  test_personal_space("Test Personal Space")


  class test_personal_space room
...
flowchart TD
  ...
  test_personal_space("Test Personal Space")
  rc_npc_basic_personal_space_1("Basic Personal Space")
  rc_npc_large_personal_space_2("Large Personal Space")
  rc_npc_small_personal_space_3("Small Personal Space")
  rc_npc_fast_backing_4("Fast Backing")
  rc_npc_slow_backing_5("Slow Backing")
  rc_npc_corner_test_wall_blocking_6("Corner Test (Wall Blocking)")
  rc_npc_personal_space_patrol_7("Personal Space + Patrol")
  rc_npc_personal_space_toggle_8("Personal Space Toggle")
  rc_npc_very_shy_extreme_9("Very Shy (Extreme)")
  rc_npc_no_personal_space_disabled_10("No Personal Space (Disabled)")

  test_personal_space --> rc_npc_basic_personal_space_1
  test_personal_space --> rc_npc_large_personal_space_2
  test_personal_space --> rc_npc_small_personal_space_3
  test_personal_space --> rc_npc_fast_backing_4
  test_personal_space --> rc_npc_slow_backing_5
  test_personal_space --> rc_npc_corner_test_wall_blocking_6
  test_personal_space --> rc_npc_personal_space_patrol_7
  test_personal_space --> rc_npc_personal_space_toggle_8
  test_personal_space --> rc_npc_very_shy_extreme_9
  test_personal_space --> rc_npc_no_personal_space_disabled_10

  class test_personal_space room
  class rc_npc_basic_personal_space_1,rc_npc_large_personal_space_2,rc_npc_small_personal_space_3,rc_npc_fast_backing_4,rc_npc_slow_backing_5,rc_npc_corner_test_wall_blocking_6,rc_npc_personal_space_patrol_7,rc_npc_personal_space_toggle_8,rc_npc_very_shy_extreme_9,rc_npc_no_personal_space_disabled_10 npc
  class node_start start
```
