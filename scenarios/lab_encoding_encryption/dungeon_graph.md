...
# lab_encoding_encryption — Scenario Graph Reference

Welcome to the Encoding and Encryption Lab! Your Crypto Instructor will guide you through encoding schemes, symmetric and asymmetric encryption, OpenSSL, and GPG. Complete the instruction and then practice your skills in the VM lab environment.
...
flowchart TD
  ...
  rc_npc_crypto_instructor_4("Crypto Instructor")
  rc_vm_launcher_desktop_5{"Desktop Terminal"}
  rc_flag_station_lab_6{"Lab Flag Submission Terminal"}

  instruction_room --> vm_lab_room
  instruction_room --> rc_lab_workstation_1
  instruction_room --> rc_obj2_2
  instruction_room --> rc_obj3_3
  instruction_room --> rc_npc_crypto_instructor_4
  vm_lab_room --> rc_vm_launcher_desktop_5
  vm_lab_room --> rc_flag_station_lab_6

  class instruction_room,vm_lab_room room
  class rc_lab_workstation_1,rc_obj2_2,rc_obj3_3,rc_vm_launcher_desktop_5,rc_flag_station_lab_6 item
  class rc_npc_crypto_instructor_4 npc
  class node_start start
```
