...
# secgen_vm_lab — Scenario Graph Reference

Welcome to the SecGen VM Lab! This environment is designed to teach you about Linux security and attack techniques. You have access to two VMs:
...
flowchart TD
  ...
  node_start(("▶"))
  node_start --> lab_entrance

  door_server_room["Server Room<br/>RFID lock"]
  server_room("Server Room")
  lab_entrance("Lab Entrance")
  lab_workstation("Lab Workstation")
  flag_room("Flag Room")

  door_server_room --> server_room
  lab_entrance --> lab_workstation
  lab_workstation --> flag_room

  class door_server_room lock
  class server_room,lab_entrance,lab_workstation,flag_room room
...
flowchart TD
  ...
  lab_entrance --> lab_workstation
  lab_workstation --> flag_room
  flag_room --> server_room

  class lab_entrance,lab_workstation,flag_room room
  class server_room lock
  class node_start start
```
...
flowchart TD
  ...
  flag_room("Flag Room")
  server_room["Server Room<br/>(locked)"]
  rc_obj1_1{"Lab Welcome Guide"}
  rc_obj2_2{"Lab Rules"}
  rc_vm_launcher_1_3{"Kali Console Terminal"}
  rc_vm_launcher_2_4{"Desktop Lab Terminal"}
  rc_obj5_5{"Attack Hints"}
  rc_flag_station_desktop_6{"Desktop Flag Terminal"}
  rc_obj7_7{"Flag Format"}
  rc_obj8_8{"Progress Tracker"}
  rc_flag_station_kali_9{"Kali Flag Terminal"}
  rc_obj10_10{"Reward Types Guide"}

  lab_entrance --> lab_workstation
  lab_workstation --> flag_room
  flag_room --> server_room
  lab_entrance --> rc_obj1_1
  lab_entrance --> rc_obj2_2
  lab_workstation --> rc_vm_launcher_1_3
  lab_workstation --> rc_vm_launcher_2_4
  lab_workstation --> rc_obj5_5
  flag_room --> rc_flag_station_desktop_6
  flag_room --> rc_obj7_7
  flag_room --> rc_obj8_8
  server_room --> rc_flag_station_kali_9
  server_room --> rc_obj10_10

  class lab_entrance,lab_workstation,flag_room room
  class server_room lock
  class rc_obj1_1,rc_obj2_2,rc_vm_launcher_1_3,rc_vm_launcher_2_4,rc_obj5_5,rc_flag_station_desktop_6,rc_obj7_7,rc_obj8_8,rc_flag_station_kali_9,rc_obj10_10 item
  class node_start start
```
