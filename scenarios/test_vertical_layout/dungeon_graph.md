...
# test_vertical_layout — Scenario Graph Reference

Test Scenario: Vertical Layout
...
flowchart TD
  ...
  class door_office1,door_ceo lock
  class office1,ceo,reception,office2 room
...
flowchart TD
  ...
  class reception,office2 room
  class office1,ceo lock
  class node_start start
```
...
flowchart TD
  ...
  office2("Office2")
  ceo["Ceo<br/>(locked)"]
  rc_obj1_1{"Welcome Note"}
  rc_obj2_2{"Office 1 Key"}
  rc_obj3_3{"CEO Office Key"}
  rc_obj4_4{"Office 2 Info"}
  rc_obj5_5{"Success Note"}
  ...
  class reception,office2 room
  class office1,ceo lock
  class rc_obj1_1,rc_obj2_2,rc_obj3_3,rc_obj4_4,rc_obj5_5 item
  class node_start start
```
