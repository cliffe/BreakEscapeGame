...
# test_simple_success — Scenario Graph Reference

TEST: Simple Success

This is a minimal 1-room scenario for testing basic objective completion and end-screen display.

Interact with the Mission Terminal to complete the objective and trigger the success screen.
...
flowchart TD
  ...
  aim_complete_mission{{"Complete the Mission"}}


  class aim_complete_mission aim
```
...
flowchart TD
  ...
  rc_success_terminal_2{"Mission Terminal"}

  test_room --> rc_obj1_1
  test_room --> rc_success_terminal_2

  class test_room room
  class rc_obj1_1,rc_success_terminal_2 item
  class node_start start
```
