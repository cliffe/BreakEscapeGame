...
# test_objectives_ink — Scenario Graph Reference

Test scenario demonstrating Ink-based objective control. Talk to NPCs to complete, unlock, and progress objectives through dialogue.
...
flowchart TD
  ...
  aim_meet_contacts{{"Meet Your Contacts"}}
  aim_secret_mission{{"The Secret Mission"}}
  aim_finale{{"Mission Complete"}}


  class aim_meet_contacts,aim_secret_mission,aim_finale aim
```
...
flowchart TD
  ...
  lobby("Lobby")
  rc_npc_alice_1("Alice")
  rc_npc_bob_2("Bob")

  lobby --> rc_npc_alice_1
  lobby --> rc_npc_bob_2

  class lobby room
  class rc_npc_alice_1,rc_npc_bob_2 npc
  class node_start start
```
