...
# test-npc-waypoints — Scenario Graph Reference

Test scenario for NPC waypoint patrol behavior
...
flowchart TD
  ...
  node_start(("▶"))
  node_start --> test_waypoint_patrol

  test_waypoint_patrol("Test Waypoint Patrol")


  class test_waypoint_patrol room
...
flowchart TD
  ...
  test_waypoint_patrol("Test Waypoint Patrol")
  rc_npc_rectangle_patrol_sequential_waypoints_1("Rectangle Patrol (Sequential Waypoints)")
  rc_npc_triangle_patrol_random_waypoints_2("Triangle Patrol (Random Waypoints)")
  rc_npc_checkpoint_patrol_with_dwell_time_3("Checkpoint Patrol (With Dwell Time)")
  rc_npc_zigzag_patrol_4("Zigzag Patrol")
  rc_npc_waypoint_patrol_face_player_5("Waypoint Patrol + Face Player")
  rc_npc_vertical_line_patrol_6("Vertical Line Patrol")
  rc_npc_horizontal_line_patrol_7("Horizontal Line Patrol")
  rc_npc_fast_waypoint_patrol_8("Fast Waypoint Patrol")
  rc_npc_slow_waypoint_patrol_9("Slow Waypoint Patrol")

  test_waypoint_patrol --> rc_npc_rectangle_patrol_sequential_waypoints_1
  test_waypoint_patrol --> rc_npc_triangle_patrol_random_waypoints_2
  test_waypoint_patrol --> rc_npc_checkpoint_patrol_with_dwell_time_3
  test_waypoint_patrol --> rc_npc_zigzag_patrol_4
  test_waypoint_patrol --> rc_npc_waypoint_patrol_face_player_5
  test_waypoint_patrol --> rc_npc_vertical_line_patrol_6
  test_waypoint_patrol --> rc_npc_horizontal_line_patrol_7
  test_waypoint_patrol --> rc_npc_fast_waypoint_patrol_8
  test_waypoint_patrol --> rc_npc_slow_waypoint_patrol_9

  class test_waypoint_patrol room
  class rc_npc_rectangle_patrol_sequential_waypoints_1,rc_npc_triangle_patrol_random_waypoints_2,rc_npc_checkpoint_patrol_with_dwell_time_3,rc_npc_zigzag_patrol_4,rc_npc_waypoint_patrol_face_player_5,rc_npc_vertical_line_patrol_6,rc_npc_horizontal_line_patrol_7,rc_npc_fast_waypoint_patrol_8,rc_npc_slow_waypoint_patrol_9 npc
  class node_start start
```
