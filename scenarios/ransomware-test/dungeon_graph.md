...
# ransomware-test — Scenario Graph Reference

Test the Ransomware Display minigame. A workstation has been compromised with ransomware. You must decide how to respond to the attack.
...
flowchart TD
  ...
  lock_infected_workstation["Infected Workstation<br/>Ransomware terminal"]
  office("Office")

  office --> lock_infected_workstation

  class lock_infected_workstation lock
  class office room
...
flowchart TD
  ...
  aim_test_ransomware{{"Test Ransomware Display"}}


  class aim_test_ransomware aim
```
...
flowchart TD
  ...
  office --> lock_infected_workstation
  lock_infected_workstation -.-> aim_test_ransomware
...
flowchart TD
  ...
  office("Office")
  rc_infected_workstation_1{"Infected Workstation"}

  office --> rc_infected_workstation_1

  class office room
  class rc_infected_workstation_1 item
  class node_start start
```
