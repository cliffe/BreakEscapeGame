...
# chat_minigame_demo — Scenario Graph Reference

A sandbox room that demonstrates every chat minigame: talk to Vega in person, text two contacts on your phones, and accept a secure video call.
...
flowchart TD
  ...
  node_start(("▶"))
  node_start --> demo_room

  demo_room("Demo Room")


  class demo_room room
...
flowchart TD
  ...
  demo_room("Demo Room")
  rc_obj1_1{"Video Console"}
  rc_npc_vega_2("Vega")
  rc_npc_handler_3("Handler")
  rc_npc_unknown_4("UNKNOWN")
  rc_npc_cipher_5("Cipher")

  demo_room --> rc_obj1_1
  demo_room --> rc_npc_vega_2
  demo_room --> rc_npc_handler_3
  demo_room --> rc_npc_unknown_4
  demo_room --> rc_npc_cipher_5

  class demo_room room
  class rc_obj1_1 item
  class rc_npc_vega_2,rc_npc_handler_3,rc_npc_unknown_4,rc_npc_cipher_5 npc
  class node_start start
```
