...
# test-phone-terminal — Scenario Graph Reference

Two phones have been left for you. One is your handler. The other is something else.
...
flowchart TD
  ...
  start_room("Start Room")
  rc_obj1_1{"Workstation"}
  rc_npc_handler_2("Handler")
  rc_npc_unknown_3("UNKNOWN")

  start_room --> rc_obj1_1
  start_room --> rc_npc_handler_2
  start_room --> rc_npc_unknown_3

  class start_room room
  class rc_obj1_1 item
  class rc_npc_handler_2,rc_npc_unknown_3 npc
  class node_start start
```
